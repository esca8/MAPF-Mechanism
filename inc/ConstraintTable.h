...
public:
    ...
    // void clear(){ct.clear(); cat_small.clear(); cat_large.clear();
    ...
    void insert2CT(const HLNode& node, int agent);
...
protected:
    ...
    // <timestep, location>: the agent must be at the given location at the
    // given timestep
